...
import com.example.movieslist.databinding.ViewHolderMovieBinding
import com.example.movieslist.BR
...
class MoviePagingAdapter : PagingDataAdapter<Movie, MoviePagingAdapter.MyViewHolder>(DIFF_UTIL) {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val variable = holder.viewDataBinding.setVariable(BR.movie, data)
